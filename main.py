...
plt.plot(births, label='Показатели рождаемости по месяцам', color='steelblue')
plt.plot(births.rolling(window=12).mean(), label='Скользящее среднее за 12 месяцев', color='orange')
...
plt.title('Рождаемость с 1949 по 1960 год', fontsize=16)
